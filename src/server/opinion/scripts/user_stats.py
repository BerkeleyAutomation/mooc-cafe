...
#geom_errorbar(aes(ymin=diffe-sd_diff, ymax=diffe+sd_diff), width=.1) + \
#geom_errorbar(aes(ymin=useful-sd_useful, ymax=useful+sd_useful), width=.1) + \
#geom_errorbar(aes(ymin=enthus-sd_enthus, ymax=enthus+sd_enthus), width=.1) + \
#geom_errorbar(aes(ymin=perf-sd_perf, ymax=perf+sd_perf), width=.1) + \
#geom_errorbar(aes(ymin=hw-sd_hw, ymax=hw+sd_hw), width=.1) + \
